...
type EnrollmentTerm struct {
	...
	Overrides     string    `json:"overrides" url:"overrides,omitempty"`           // Term date overrides for specific enrollment types.Example: {'start_at'=>'2014-01-07T08:00:00-05:00', 'end_at'=>'2014-05-14T05:00:00-04:0'}
}
