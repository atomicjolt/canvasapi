...
type QuizStatisticsSubmissionStatistics struct {
	...
	Scores                string  `json:"scores" url:"scores,omitempty"`                                   // A percentile distribution of the student scores, each key is the percentile (ranges between 0 and 100%) while the value is the number of students who received that score..Example: 1, 5, 1
