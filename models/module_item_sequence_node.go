...
type ModuleItemSequenceNode struct {
	...
	MasteryPath string      `json:"mastery_path" url:"mastery_path,omitempty"` // The conditional release rule for the module item, if applicable.Example: true, , , false, false, /courses/11/modules, /courses/11/modules/items/9/choose, false
}
