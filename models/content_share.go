...
type ContentShare struct {
	...
	Sender        map[string](interface{}) `json:"sender" url:"sender,omitempty"`                 // The user who shared the content. This field is provided only to receivers; it is not populated in the sender's list of sent content shares..Example: 1, Matilda Vargas, http://localhost:3000/image_url, http://localhost:3000/users/1
	...
	SourceCourse  map[string](interface{}) `json:"source_course" url:"source_course,omitempty"`   // The course the content was originally shared from..Example: 787, History 105
...
func (t *ContentShare) HasErrors() error {
	return nil
}
