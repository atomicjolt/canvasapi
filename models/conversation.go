...
type Conversation struct {
	...
	Audience         []int64                    `json:"audience" url:"audience,omitempty"`                   // Array of user ids who are involved in the conversation, ordered by participation level, then alphabetical. Excludes current user, unless this is a monologue..
