...
type Conference struct {
	...
	Users               []int64                `json:"users" url:"users,omitempty"`                                 // Array of user ids that are participants in the conference.Example: 1, 7, 8, 9, 10
	...
	UserSettings        string                 `json:"user_settings" url:"user_settings,omitempty"`                 // A collection of settings specific to the conference type.Example: true
