...
type QuizQuestion struct {
	...
	PointsPossible    float64   `json:"points_possible" url:"points_possible,omitempty"`       // The maximum amount of points possible received for getting this question correct..Example: 5
