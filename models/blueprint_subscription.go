...
type BlueprintSubscription struct {
	...
	BlueprintCourse map[string](interface{}) `json:"blueprint_course" url:"blueprint_course,omitempty"` // The blueprint course subscribed to.Example: 2, Biology 100 Blueprint, BIOL 100 BP, Default term
}

func (t *BlueprintSubscription) HasErrors() error {
	return nil
}
