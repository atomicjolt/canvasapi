...
type NamesAndRoleMessage struct {
	...
	Custom            string `json:"custom" url:"custom,omitempty"`                             // Expanded LTI custom parameters that pertain to the member (as opposed to the Context).Example: en, America/Denver
}
