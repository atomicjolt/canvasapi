...
type PollSession struct {
	...
	Results          string          `json:"results" url:"results,omitempty"`                       // The results of the submissions of the poll. Each key is the poll choice id, and the value is the count of submissions..Example: 10, 3, 27, 8
