...
type Group struct {
	...
	Permissions     string  `json:"permissions" url:"permissions,omitempty"`             // optional: the permissions the user has for the group. returned only for a single group and include[]=permissions.Example: true, true
