...
type Module struct {
	...
	PrerequisiteModuleIDs     []string      `json:"prerequisite_module_ids" url:"prerequisite_module_ids,omitempty"`         // IDs of Modules that must be completed before this one is unlocked.Example: 121, 122
