...
type GradingRules struct {
	...
	NeverDrop   []string `json:"never_drop" url:"never_drop,omitempty"`     // Assignment IDs that should never be dropped..Example: 33, 17, 24
}

func (t *GradingRules) HasErrors() error {
	return nil
}
