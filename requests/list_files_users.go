...
// ListFilesUsers Returns the paginated list of files for the folder or course.
...
func (t *ListFilesUsers) GetMethod() string {
	return "GET"
}

func (t *ListFilesUsers) GetURLPath() string {
	path := "users/{user_id}/files"
	path = strings.ReplaceAll(path, "{user_id}", fmt.Sprintf("%v", t.Path.UserID))
	return path
}

func (t *ListFilesUsers) GetQuery() (string, error) {
...
func (t *ListFilesUsers) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *ListFilesUsers) GetJSON() ([]byte, error) {
	return nil, nil
}
...
func (t *ListFilesUsers) Do(c *canvasapi.Canvas, next *url.URL) ([]*models.File, *canvasapi.PagedResource, error) {
	var err error
