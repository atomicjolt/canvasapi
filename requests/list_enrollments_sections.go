...
func (t *ListEnrollmentsSections) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *ListEnrollmentsSections) GetJSON() ([]byte, error) {
	return nil, nil
}
...
func (t *ListEnrollmentsSections) Do(c *canvasapi.Canvas, next *url.URL) ([]*models.Enrollment, *canvasapi.PagedResource, error) {
	var err error
