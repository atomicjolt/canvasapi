...
func (t *ListFeaturesAccounts) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *ListFeaturesAccounts) GetJSON() ([]byte, error) {
	return nil, nil
}
...
func (t *ListFeaturesAccounts) Do(c *canvasapi.Canvas, next *url.URL) ([]*models.Feature, *canvasapi.PagedResource, error) {
	var err error
