...
func (t *ListContentSharesReceived) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *ListContentSharesReceived) GetJSON() ([]byte, error) {
	return nil, nil
}
...
func (t *ListContentSharesReceived) Do(c *canvasapi.Canvas, next *url.URL) ([]*models.ContentShare, *canvasapi.PagedResource, error) {
	var err error
