...
//
// Path Parameters:
// # Path.ID (Required) the ID or SIS ID of the course to remove
//
...
func (t *RemoveCourseFromFavorites) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *RemoveCourseFromFavorites) GetJSON() ([]byte, error) {
	return nil, nil
}
