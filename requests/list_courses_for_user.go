...
// ListCoursesForUser Returns a paginated list of active courses for this user. To view the course list for a user other than yourself, you must be either an observer of that user or an administrator.
...
func (t *ListCoursesForUser) GetMethod() string {
	return "GET"
}

func (t *ListCoursesForUser) GetURLPath() string {
	path := "users/{user_id}/courses"
	path = strings.ReplaceAll(path, "{user_id}", fmt.Sprintf("%v", t.Path.UserID))
	return path
}

func (t *ListCoursesForUser) GetQuery() (string, error) {
...
func (t *ListCoursesForUser) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *ListCoursesForUser) GetJSON() ([]byte, error) {
	return nil, nil
}
...
func (t *ListCoursesForUser) Do(c *canvasapi.Canvas, next *url.URL) ([]*models.Course, *canvasapi.PagedResource, error) {
	var err error
