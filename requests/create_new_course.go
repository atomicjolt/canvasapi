...
// # Form.Course.PublicSyllabusToAuth (Optional) Set to true to make the course syllabus public for authenticated users.
...
//    immediately.
// # Form.EnrollMe (Optional) Set to true to enroll the current user as the teacher.
...
// # Form.Course.GradePassbackSetting (Optional) Optional. The grade_passback_setting for the course. Only 'nightly_sync', 'disabled', and '' are allowed
// # Form.Course.CourseFormat (Optional) Optional. Specifies the format of the course. (Should be 'on_campus', 'online', or 'blended')
// # Form.EnableSISReactivation (Optional) When true, will first try to re-activate a deleted course with matching sis_course_id if possible.
//
