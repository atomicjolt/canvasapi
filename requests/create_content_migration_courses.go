...
// CreateContentMigrationCourses Create a content migration. If the migration requires a file to be uploaded
...
func (t *CreateContentMigrationCourses) GetMethod() string {
	return "POST"
}

func (t *CreateContentMigrationCourses) GetURLPath() string {
	path := "courses/{course_id}/content_migrations"
	path = strings.ReplaceAll(path, "{course_id}", fmt.Sprintf("%v", t.Path.CourseID))
	return path
}

func (t *CreateContentMigrationCourses) GetQuery() (string, error) {
	return "", nil
}
...
func (t *CreateContentMigrationCourses) Do(c *canvasapi.Canvas) (*models.ContentMigration, error) {
