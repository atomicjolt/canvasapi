...
// ListFilesCourses Returns the paginated list of files for the folder or course.
...
func (t *ListFilesCourses) GetMethod() string {
	return "GET"
}

func (t *ListFilesCourses) GetURLPath() string {
	path := "courses/{course_id}/files"
	path = strings.ReplaceAll(path, "{course_id}", fmt.Sprintf("%v", t.Path.CourseID))
	return path
}

func (t *ListFilesCourses) GetQuery() (string, error) {
...
func (t *ListFilesCourses) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *ListFilesCourses) GetJSON() ([]byte, error) {
	return nil, nil
}

func (t *ListFilesCourses) HasErrors() error {
	errs := []string{}
	if t.Path.CourseID == "" {
...
func (t *ListFilesCourses) Do(c *canvasapi.Canvas, next *url.URL) ([]*models.File, *canvasapi.PagedResource, error) {
	var err error
