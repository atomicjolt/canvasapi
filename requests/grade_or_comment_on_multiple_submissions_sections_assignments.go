...
func (t *GradeOrCommentOnMultipleSubmissionsSectionsAssignments) GetBody() (url.Values, error) {
	return query.Values(t.Form)
}

func (t *GradeOrCommentOnMultipleSubmissionsSectionsAssignments) GetJSON() ([]byte, error) {
