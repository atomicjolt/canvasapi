...
//
// Path Parameters:
// # CourseID (Required) The ID of the course to query.
//
// Query Parameters:
// # AccountID (Optional) The ID of the account to query.
...
func (t *RetrieveAssignmentsEnabledForGradeExportToSISCourses) GetBody() (string, error) {
	return "", nil
}
