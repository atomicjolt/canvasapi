...
// ListEnrollmentsUsers Depending on the URL given, return a paginated list of either (1) all of
...
//
// Path Parameters:
// # Path.UserID (Required) Filter by user_id (only valid for course or section enrollment
...
//
type ListEnrollmentsUsers struct {
	Path struct {
...
func (t *ListEnrollmentsUsers) GetMethod() string {
	return "GET"
}

func (t *ListEnrollmentsUsers) GetURLPath() string {
	path := "users/{user_id}/enrollments"
	path = strings.ReplaceAll(path, "{user_id}", fmt.Sprintf("%v", t.Path.UserID))
	return path
}

func (t *ListEnrollmentsUsers) GetQuery() (string, error) {
...
func (t *ListEnrollmentsUsers) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *ListEnrollmentsUsers) GetJSON() ([]byte, error) {
	return nil, nil
}

func (t *ListEnrollmentsUsers) HasErrors() error {
	errs := []string{}
...
func (t *ListEnrollmentsUsers) Do(c *canvasapi.Canvas, next *url.URL) ([]*models.Enrollment, *canvasapi.PagedResource, error) {
	var err error
