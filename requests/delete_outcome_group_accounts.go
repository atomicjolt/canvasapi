...
// DeleteOutcomeGroupAccounts Deleting an outcome group deletes descendant outcome groups and outcome
...
func (t *DeleteOutcomeGroupAccounts) GetMethod() string {
	return "DELETE"
}

func (t *DeleteOutcomeGroupAccounts) GetURLPath() string {
...
func (t *DeleteOutcomeGroupAccounts) GetQuery() (string, error) {
	return "", nil
}
...
func (t *DeleteOutcomeGroupAccounts) Do(c *canvasapi.Canvas) (*models.OutcomeGroup, error) {
