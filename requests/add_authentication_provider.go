...
// AddAuthenticationProvider Add external authentication provider(s) for the account.
...
//
type AddAuthenticationProvider struct {
	Path struct {
		AccountID string `json:"account_id" url:"account_id,omitempty"` //  (Required)
	} `json:"path"`
}

func (t *AddAuthenticationProvider) GetMethod() string {
	return "POST"
}

func (t *AddAuthenticationProvider) GetURLPath() string {
	path := "accounts/{account_id}/authentication_providers"
	path = strings.ReplaceAll(path, "{account_id}", fmt.Sprintf("%v", t.Path.AccountID))
	return path
}

func (t *AddAuthenticationProvider) GetQuery() (string, error) {
	return "", nil
}

func (t *AddAuthenticationProvider) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *AddAuthenticationProvider) GetJSON() ([]byte, error) {
	return nil, nil
}

func (t *AddAuthenticationProvider) HasErrors() error {
	errs := []string{}
	if t.Path.AccountID == "" {
...
func (t *AddAuthenticationProvider) Do(c *canvasapi.Canvas) (*models.AuthenticationProvider, error) {
