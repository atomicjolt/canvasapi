...
//
// Form Parameters:
// # Assignment (Optional) The assignment name.
// # Assignment (Optional) The position of this assignment in the group when displaying
//    assignment lists.
// # Assignment (Optional) . Must be one of online_quiz, none, on_paper, discussion_topic, external_tool, online_upload, online_text_entry, online_url, media_recording, student_annotationOnly applies if the assignment doesn't have student submissions.
//
...
//    format.
// # Assignment (Optional) The sis id of the Assignment
...
// # Assignment (Optional) The day/time the assignment is due.
...
// # Assignment (Optional) The number of submission attempts allowed for this assignment. Set to -1 or null for
//    unlimited attempts.
...
type EditAssignment struct {
	...
	Form struct {
		Assignment struct {
			...
			SISAssignmentID                  string                       `json:"sis_assignment_id"`                     //  (Optional)
...
func (t *EditAssignment) GetBody() (string, error) {
