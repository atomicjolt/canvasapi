...
// GetFileFiles Returns the standard attachment json object
...
func (t *GetFileFiles) GetMethod() string {
	return "GET"
}

func (t *GetFileFiles) GetURLPath() string {
	path := "files/{id}"
	path = strings.ReplaceAll(path, "{id}", fmt.Sprintf("%v", t.Path.ID))
	return path
}

func (t *GetFileFiles) GetQuery() (string, error) {
...
func (t *GetFileFiles) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *GetFileFiles) GetJSON() ([]byte, error) {
	return nil, nil
}
...
func (t *GetFileFiles) Do(c *canvasapi.Canvas) (*models.File, error) {
