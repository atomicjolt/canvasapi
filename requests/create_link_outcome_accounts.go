...
// CreateLinkOutcomeAccounts Link an outcome into the outcome group. The outcome to link can either be
...
func (t *CreateLinkOutcomeAccounts) GetMethod() string {
	return "POST"
}

func (t *CreateLinkOutcomeAccounts) GetURLPath() string {
...
func (t *CreateLinkOutcomeAccounts) GetQuery() (string, error) {
	return "", nil
}
...
func (t *CreateLinkOutcomeAccounts) Do(c *canvasapi.Canvas) (*models.OutcomeLink, error) {
