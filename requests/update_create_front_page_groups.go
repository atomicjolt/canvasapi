...
// UpdateCreateFrontPageGroups Update the title or contents of the front page
...
func (t *UpdateCreateFrontPageGroups) GetMethod() string {
	return "PUT"
}

func (t *UpdateCreateFrontPageGroups) GetURLPath() string {
	path := "groups/{group_id}/front_page"
	path = strings.ReplaceAll(path, "{group_id}", fmt.Sprintf("%v", t.Path.GroupID))
	return path
}

func (t *UpdateCreateFrontPageGroups) GetQuery() (string, error) {
	return "", nil
}
...
func (t *UpdateCreateFrontPageGroups) Do(c *canvasapi.Canvas) (*models.Page, error) {
