...
// ListItemsForSelectiveImportGroups Enumerates the content available for selective import in a tree structure. Each node provides
...
//
type ListItemsForSelectiveImportGroups struct {
	Path struct {
...
func (t *ListItemsForSelectiveImportGroups) GetMethod() string {
	return "GET"
}

func (t *ListItemsForSelectiveImportGroups) GetURLPath() string {
	path := "groups/{group_id}/content_migrations/{id}/selective_data"
	path = strings.ReplaceAll(path, "{group_id}", fmt.Sprintf("%v", t.Path.GroupID))
	path = strings.ReplaceAll(path, "{id}", fmt.Sprintf("%v", t.Path.ID))
	return path
}

func (t *ListItemsForSelectiveImportGroups) GetQuery() (string, error) {
...
func (t *ListItemsForSelectiveImportGroups) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *ListItemsForSelectiveImportGroups) GetJSON() ([]byte, error) {
	return nil, nil
}

func (t *ListItemsForSelectiveImportGroups) HasErrors() error {
	errs := []string{}
	if t.Path.GroupID == "" {
...
func (t *ListItemsForSelectiveImportGroups) Do(c *canvasapi.Canvas) (*[]string, error) {
