...
// ListItemsForSelectiveImportUsers Enumerates the content available for selective import in a tree structure. Each node provides
...
//
type ListItemsForSelectiveImportUsers struct {
	Path struct {
...
func (t *ListItemsForSelectiveImportUsers) GetMethod() string {
	return "GET"
}

func (t *ListItemsForSelectiveImportUsers) GetURLPath() string {
	path := "users/{user_id}/content_migrations/{id}/selective_data"
	path = strings.ReplaceAll(path, "{user_id}", fmt.Sprintf("%v", t.Path.UserID))
	path = strings.ReplaceAll(path, "{id}", fmt.Sprintf("%v", t.Path.ID))
	return path
}

func (t *ListItemsForSelectiveImportUsers) GetQuery() (string, error) {
...
func (t *ListItemsForSelectiveImportUsers) GetBody() (url.Values, error) {
	return nil, nil
}

func (t *ListItemsForSelectiveImportUsers) GetJSON() ([]byte, error) {
	return nil, nil
}

func (t *ListItemsForSelectiveImportUsers) HasErrors() error {
	errs := []string{}
	if t.Path.UserID == "" {
...
func (t *ListItemsForSelectiveImportUsers) Do(c *canvasapi.Canvas) (*[]string, error) {
