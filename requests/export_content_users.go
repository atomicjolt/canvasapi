...
// ExportContentUsers Begin a content export job for a course, group, or user.
//
...
func (t *ExportContentUsers) GetMethod() string {
	return "POST"
}

func (t *ExportContentUsers) GetURLPath() string {
	path := "users/{user_id}/content_exports"
	path = strings.ReplaceAll(path, "{user_id}", fmt.Sprintf("%v", t.Path.UserID))
	return path
}

func (t *ExportContentUsers) GetQuery() (string, error) {
	return "", nil
}
...
func (t *ExportContentUsers) Do(c *canvasapi.Canvas) (*models.ContentExport, error) {
